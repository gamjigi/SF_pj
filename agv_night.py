...
def handle_client(client_socket):
    while True:
        ...
        if data == "dark":
            rospy.loginfo("401을 입력하시오")
            data_1 = input("Enter_401")
            if data_1 in ["401", "402", "403"]:
                rospy.loginfo(f"{data_1}을 받았습니다. 좌표 이동을 시작합니다.")
                try:
                    goal_x, goal_y = get_goal_coordinates(int(data_1))
